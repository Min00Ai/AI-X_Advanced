Code 실행 여부 X , (API 계정 등의 문제가 있습니다.)
...
- Architecture
  ...
  - OCR 실행 Timestamp 및 해당 강의 내용을 Meta-Data로 저장(with ASR)
    - 예 1
    - time: xx:xx
  ...
  - 사용자에게 효율적 학습 경험 제공
    - 복습할 부분 영상 검색 기능
      - RAG을 적용하여 위에 Text로 저장한 Docs에서 복습 부분의 Time 값 가져옴 (영상 네비게이션 기능)
...
- 데모 영상
  - https://github.com/user-attachments/assets/a22c8c7a-6153-47f0-b864-0c6aa9f3bdf1
